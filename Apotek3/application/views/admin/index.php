...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0" style="color: black;">Data admin</h1>
		<a href="#" data-toggle="modal" data-target="#tambahModal"
			class="btn btn-sm btn-ok shadow-sm" style="color: white;">Tambah data admin</a>
    </div>
    <div class="row">
	<div class="col-lg-12">
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold" style="color: green;">List admin</h6>
			</div>
			<div class="card-body">
						...
						<tr>
							...
							<td>
								...
								<a href="" data-id="<?php echo $o->id; ?>"
									class="btn btn-ok btn-circle btn-sm btn-ubah-adm" style="color: white;"><i
